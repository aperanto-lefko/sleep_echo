...
{
    internal class UpdateRespondentRequest
    {
        [Required(ErrorMessage = "Поле \"Id\" не должно быть пустым")]
        ...
        public UpdateRespondentRequest(int id,
                                       string firstName, 
                                       string lastName, 
                                       string email, 
                                       string gender,
        ...
        public UpdateRespondentRequest() { }
